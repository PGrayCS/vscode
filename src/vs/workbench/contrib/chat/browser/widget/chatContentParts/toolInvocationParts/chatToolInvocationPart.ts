...
import { isToolMcpUiOutput, isToolResultInputOutputDetails, isToolResultOutputDetails, ToolInvocationPresentation, ToolMcpUiOutput } from '../../../../common/tools/languageModelToolsService.js';
...
export class ChatToolInvocationPart extends Disposable implements IChatContentPart {
	...
	private createToolInvocationSubPart(): BaseChatToolInvocationSubPart {
		...
		if (isToolResultInputOutputDetails(resultDetails)) {
			...
			if (mcpAppOutput) {
				return this.instantiationService.createInstance(ChatMcpAppSubPart, this.toolInvocation, mcpAppOutput, this.context);
			}
